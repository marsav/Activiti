 ...
 * @author Joram Barrez
 */
class GeraProcessInstanceTableItem extends PropertysetItem implements Comparable<GeraProcessInstanceTableItem> {
  ...
  public static final String PROPERTY_ACTIONS = "actions";
    public static final String PROPERTY_CATHEGORY = "cathegory";

  public GeraProcessInstanceTableItem(final ProcessInstance processInstance) {
    addItemProperty(PROPERTY_ID, new ObjectProperty<String>(processInstance.getId(), String.class));

//    addItemProperty(PROPERTY_CATHEGORY, new ObjectProperty<String>(processInstance.get, String.class));
  ...
  public int compareTo(GeraProcessInstanceTableItem other) {
