...
public class Images {
  ...
  public static final Resource SPACER = new ThemeResource("img/content-bg.png");
  public static final Resource REPOSITORY_50 = new ThemeResource("img/repository-50.png");
}
